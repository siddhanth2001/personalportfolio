...
const ProjectCard = ({ title, description, techStack, imageUrl, githubUrl, delay }: ProjectProps) => {
  return (
    <motion.div 
      ...
      className="bg-background rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all"
    >
      ...
      <div className="p-6 flex flex-col justify-between min-h-[340px]">
        <div>
          ...
          <a 
            ...
            className="inline-flex items-center text-accent hover:underline font-medium mb-3"
          >
